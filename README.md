...
<p>Сервис проверяет поле next_pay_day в таблице clients и выписывает ему счет за тариф с тарификацией за определенный период времени и затем обновляет дату для следующего списания</p>
