...
cdr_path = "cdrs//cdr3.json"
cdr_path_for_func = "..//IntegrationTests//brt//cdrs//cdr3.json"
...
def test_cdr_processing(json_file: str = cdr_path):
    ...
    send_cdr_from_file(cdr_path_for_func)
