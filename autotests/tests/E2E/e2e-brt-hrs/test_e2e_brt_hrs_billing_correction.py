...
def test_e2e_correct_outgoing_billing_tariff1_test(e2e_setup):
    ...
    oldbalance_1 = get_brt_balance(TEST_ABONENT_ID)
...
def test_e2e_correct_incomming_billing_tariff1_test(e2e_setup):
